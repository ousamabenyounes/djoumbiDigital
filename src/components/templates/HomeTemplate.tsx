...
const services = [
  {
    icon: FaLightbulb,
    title: "Innovation IT",
    description: "Solutions technologiques innovantes adaptées à vos besoins",
  },
  {
    icon: FaBrain,
    title: "Coaching IA",
    description: "Accompagnement dans votre transformation digitale avec l'IA",
  },
  {
    icon: FaChartLine,
    title: "Excellence Technique",
    description: "Services IT de qualité et support technique personnalisé",
  },
];
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <Link
              href="/fr/contact"
              className="group inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-primary-600 rounded-full hover:bg-primary-700 transition-all duration-300 hover:shadow-lg"
            >
              {t('home.hero.cta')}
